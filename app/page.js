...
const HERO_SLIDES = [
  ...
  {
    phrase:    'Automatisez tout,',
    highlight: 'gagnez du temps.',
    color:     '#0ea5e9',
    bubbleBg:  '#e0f2fe',
    badgeLabel:'Workflow IA',
    badgeBg:   '#0ea5e9',
    IllustrationJSX: () => (
      <div style={{ background:'#fff', borderRadius:14, padding:'12px 14px', boxShadow:'0 4px 18px rgba(0,0,0,0.10)', width:170 }}>
  ...
  {
    phrase:    'Des documents pro,',
    highlight: 'en quelques secondes.',
    color:     '#10b981',
    bubbleBg:  '#d1fae5',
    badgeLabel:'CV Builder',
    badgeBg:   '#10b981',
    IllustrationJSX: () => (
      <div style={{ background:'#fff', borderRadius:14, padding:'12px 14px', boxShadow:'0 4px 18px rgba(0,0,0,0.10)', width:170 }}>
  ...
  {
    phrase:    'Analysez, décidez,',
    highlight: 'performez mieux.',
    color:     '#f59e0b',
    bubbleBg:  '#fef3c7',
...
function RotatingHero({ user }) {
  ...
  const Illus = slide.IllustrationJSX
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="flex-1 min-w-0">
          ...
          <h1 className="text-5xl md:text-[64px] font-black tracking-tight leading-[1.05] mb-6">
            {/* Animated colored phrase */}
            <span className={`block ${textClass}`} style={{ color: slide.color, minHeight: '1.15em' }}>
              {slide.phrase}
            </span>
            {/* Animated gradient highlight — slight stagger via delay */}
            <span
  ...
  return (
    <main className="min-h-screen bg-[#f8fafc] font-sans text-slate-900 overflow-x-hidden">
      ...
      <div className={mounted ? 'reveal reveal-1' : 'opacity-0'}>
        ...
        {/* Google-Ads-style rotating hero */}
