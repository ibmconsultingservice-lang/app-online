...
export default function ProjectDeepWork() {
  ...
  const [totalDays, setTotalDays] = useState(28); // Initialisé à 4 semaines
  ...
  return (
    <div className="app-container">
      ...
      <aside className="sidebar">
        <div style={{padding: '10px 0 30px', fontWeight: 800, fontSize: 18, color: 'var(--primary)'}}>NEXUS</div>
      ...
      <main className="main-content">
        <header className="header">
          ...
          <div style={{display:'flex', gap: 12, alignItems: 'center'}}>
            ...
            {/* MODIFICATION : Sélecteur par Semaine */}
                  ...
                  <div key={t.id} style={{
                    ...
                    <div style={{flex: 1, position: 'relative', height: '100%'}}>
                      <div className="gantt-bar"
                        ...
                        style={{ 
                          left: (t.start - 1) * ZOOM + 2, 
                          width: t.duration * ZOOM - 4, 
                          background: COLORS[t.colorIdx],
                        }}
                      >
      ...
      {/* Modal - Identique avec support des jours max dynamiques */}
      {isModalOpen && (
