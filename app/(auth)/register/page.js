        ...
        <div className="bg-white border border-slate-200 rounded-3xl shadow-xl shadow-slate-200/50 p-10">
          <div className="flex flex-col items-center mb-10">
            ...
            <p className="text-slate-400 text-[10px] font-bold mt-2 uppercase tracking-widest">
              Créez votre compte —{' '}
              <span className="text-indigo-600">10 crédits offerts 🎁</span>
            </p>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <button type="submit" disabled={loading}
              className="w-full bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl py-3 text-[11px] font-black uppercase tracking-widest transition-all shadow-lg shadow-indigo-500/25 disabled:opacity-50 flex items-center justify-center gap-2">
