...
export async function POST(request) {
  try {
    ...
    const { cardName, vision, strategie, objectives, projectName, projectTag } = body
...
6. Les priorités doivent être ordonnées par urgence × impact, avec des actions concrètes`
    ...
    try {
      ...
      // Ensure scoreParPerspective has all 4 keys
      ...
      // Ensure perspective field on each recommendation
