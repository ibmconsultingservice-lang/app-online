  ...
  return (
    <div className="min-h-screen bg-[#e0e0e0] py-10 px-4 font-sans text-[#333]">
      ...
      <div className="bg-white max-w-[850px] mx-auto shadow-[0_10px_30px_rgba(0,0,0,0.1)] rounded-lg overflow-hidden border border-gray-200 invoice-card">
        ...
        {/* En-tête */}
        <div
          className="p-10 flex justify-between items-center transition-colors duration-500"
          ...
          <div className="text-right">
            ...
            <p
              className="opacity-80 outline-none"
              contentEditable
        ...
        <div className="flex justify-between p-10">
          <div className="space-y-1">
            <h3
              className="border-b-2 border-[#f4f7f8] pb-1 mb-2 font-bold uppercase text-sm"
            ...
            {items.map((item) => (
              <tr key={item.id} className="border-b border-gray-100 hover:bg-gray-50 group">
                ...
                <td className="p-4 text-right font-medium">
                  {(item.qty * item.price).toLocaleString()} CFA
                </td>
        ...
        <div className="p-10 flex justify-end">
          <div className="w-72 space-y-2">
            ...
            <div className="flex justify-between text-gray-600 text-sm items-center">
              <span>
                ...
                <span
                  contentEditable
                  suppressContentEditableWarning
                  onBlur={(e) => setTvaRate(parseInt(e.target.innerText) || 0)}>
                  {tvaRate}
                </span>
                %) :
              </span>
            ...
            <div
              className="flex justify-between text-white p-4 rounded mt-4 font-bold text-lg transition-colors duration-500"
